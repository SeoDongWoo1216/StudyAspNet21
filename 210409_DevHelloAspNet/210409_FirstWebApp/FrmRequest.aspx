<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmRequest.aspx.cs" Inherits="_210409_FirstWebApp.FrmRequest" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="LblReslt" runat="server" ></asp:Label> <br />

...
namespace _210414_DotNetNote.Models
{
    public class DbRepository
    {
        ...
        public int SaveOrUpdate(Note n, BoardWriteFormType formType)
        {
            ...
            switch (formType)
            {
                case BoardWriteFormType.Write:
                    ...
                    r = con.Execute("WriteNote", p , commandType: CommandType.StoredProcedure);  // 저장프로시저 결과 값 1(저장성공) or 0(저장실패) 반환
                    break;
        ...
        // 깃허브의 NoteCommentRepository.cs 내용을 합쳤음
